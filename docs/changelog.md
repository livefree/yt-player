...
- 新增 `SEQ-20260407-37`
- 本轮聚焦空 settings 入口的错误交互：保留按钮，但在无可用设置项时灰化禁用，阻止空弹窗打开

# 2026-04-07 19:36

- 完成 `SEQ-20260407-37 / PLAYER-69`
- 空 settings 入口已改为“按钮保留但禁用”，不会再渲染可点击的空弹窗路径
- settings 真有内容时仍可正常打开，overlay manager 相关契约测试已改为在存在 subtitles 的情况下验证
- 回归测试通过，当前总数为 86
