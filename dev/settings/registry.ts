...
export const REGISTRY: ComponentDef[] = [
  ...
  },
  {
    ...
    vars: [
      ...
      { variable: "--ytp-btn-height",           label: "BG Height",            type: "px",    default: "32px", min: 16, max: 56, step: 2 },
      { variable: "--ytp-play-btn-width",       label: "BG Width",             type: "px",    default: "32px", min: 16, max: 80, step: 2 },
      { variable: "--ytp-btn-hover-height",     label: "Hover Height",         type: "px",    default: "32px", min: 16, max: 56, step: 2 },
      { variable: "--ytp-play-btn-hover-width", label: "Hover Width",          type: "px",    default: "32px", min: 16, max: 80, step: 2 },
      { variable: "--ytp-pill-bg",              label: "BG Color",             type: "color", default: "rgba(0,0,0,0.15)" },
      { variable: "--ytp-pill-btn-hover-bg",    label: "Hover BG Color",       type: "color", default: "rgba(255,255,255,0.12)" },
    ],
  },
  {
    id: "next-btn",
    label: "Next Button",
    vars: [
      { variable: "--ytp-next-btn-width",       label: "BG Width",             type: "px",    default: "32px", min: 16, max: 80, step: 2 },
      { variable: "--ytp-next-btn-hover-width", label: "Hover Width",          type: "px",    default: "32px", min: 16, max: 80, step: 2 },
    ],
  },
  {
    id: "volume-area",
...
export const ALL_VARS: string[] = [
  ...
  "--ytp-btn-gap",
  "--ytp-btn-height",
  "--ytp-btn-hover-height",
  "--ytp-play-btn-width",
  "--ytp-play-btn-hover-width",
  "--ytp-next-btn-width",
  "--ytp-next-btn-hover-width",
  "--ytp-pill-bg",
